import 'package:{{project_name}}/model/exceptions/general_network_error.dart';
...
void main() {
  ...
  group('After init', () {
    ...
    group('onDownloadClicked', () {
      ...
      test('TodoListViewModel onDownloadClicked with {{project_name.pascalCase()}}Error', () async {
      ...
      test('TodoListViewModel onDownloadClicked with no {{project_name.pascalCase()}}Error', () async {
