...
const originalProjectName = '{{project_name}}';
const originalClassNamePrefix = '{{project_name.pascalCase()}}';
const originalIOSBundleIdentifier = '{{project_package_name}}';
const originalAndroidPackageName = '{{project_package_name}}';
const originalAndroidFolderPath = '{{project_package_name.pathCase()wo}}';
const originalAppName = '{{project_name.pascalCase()}}';
const originalDescription = 'A {{project_name.pascalCase()}} to get started quickly';
