...
import '../database/{{project_name}}_database.dart' as _i10;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i10.{{project_name.pascalCase()}}Database>(() => registerModule
      .provide{{project_name.pascalCase()}}Database(get<_i6.DatabaseConnection>()));
  ...
  gh.lazySingleton<_i16.TodoDaoStorage>(
      () => _i16.TodoDaoStorage(get<_i10.{{project_name.pascalCase()}}Database>()));
