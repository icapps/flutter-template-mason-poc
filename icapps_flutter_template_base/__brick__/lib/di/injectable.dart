...
import 'package:{{project_name}}/di/db/setup_drift_none.dart'
    if (dart.library.io) 'package:{{project_name}}/di/db/setup_drift_io.dart'
    if (dart.library.js) 'package:{{project_name}}/di/db/setup_drift_web.dart';
...
import 'package:{{project_name}}/util/interceptor/network_error_interceptor.dart';
import 'package:{{project_name}}/util/interceptor/network_log_interceptor.dart';
import 'package:{{project_name}}/util/interceptor/network_refresh_interceptor.dart';
...
abstract class RegisterModule {
  ...
  @lazySingleton
  {{project_name.pascalCase()}}Database provide{{project_name.pascalCase()}}Database(DatabaseConnection databaseConnection) => {{project_name.pascalCase()}}Database.connect(databaseConnection);
}
