...
import 'package:{{project_name}}/widget/general/svg_icon.dart';
import 'package:{{project_name}}/widget/provider/data_provider_widget.dart';
import 'package:icapps_architecture/icapps_architecture.dart';

class {{project_name.pascalCase()}}CheckBox extends StatelessWidget {
  final bool value;
  final ValueChanged<bool> onChanged;

  const {{project_name.pascalCase()}}CheckBox({
    required this.value,
