...
import 'package:{{project_name}}/util/cache/cache_controlling.dart';
import 'package:{{project_name}}/util/env/flavor_config.dart';
import 'package:get_it/get_it.dart';
import 'package:icapps_architecture/icapps_architecture.dart';

class {{project_name.pascalCase()}}NetworkImage extends StatelessWidget {
  final String? url;
  ...
  const {{project_name.pascalCase()}}NetworkImage({
    required this.url,
    this.fallbackUrl,
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return SizedBox(
          height: imgHeight,
          width: imgWidth,
          child: _{{project_name.pascalCase()}}BetterNetworkImage(
            imageUrl: correctUrl,
            height: imgHeight,
            width: imgWidth,
            fit: fit,
...
class _{{project_name.pascalCase()}}BetterNetworkImage extends StatefulWidget {
  ...
  const _{{project_name.pascalCase()}}BetterNetworkImage({
  ...
  @override
  _{{project_name.pascalCase()}}BetterNetworkImageState createState() => _{{project_name.pascalCase()}}BetterNetworkImageState();
}

class _{{project_name.pascalCase()}}BetterNetworkImageState extends State<_{{project_name.pascalCase()}}BetterNetworkImage> {
  ...
  @override
  void didUpdateWidget(_{{project_name.pascalCase()}}BetterNetworkImage oldWidget) {
