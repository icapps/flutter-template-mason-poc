...
part of '{{project_name}}_database.dart';
...
abstract class _${{project_name.pascalCase()}}Database extends GeneratedDatabase {
  _${{project_name.pascalCase()}}Database(QueryExecutor e)
      : super(SqlTypeSystem.defaultInstance, e);
  _${{project_name.pascalCase()}}Database.connect(DatabaseConnection c) : super.connect(c);
