...
abstract class TodoDaoStorage {
  @factoryMethod
  factory TodoDaoStorage({{project_name.pascalCase()}}Database db) = _TodoDaoStorage;
...
class _TodoDaoStorage extends DatabaseAccessor<{{project_name.pascalCase()}}Database> with _$_TodoDaoStorageMixin implements TodoDaoStorage {
  _TodoDaoStorage({{project_name.pascalCase()}}Database db) : super(db);
